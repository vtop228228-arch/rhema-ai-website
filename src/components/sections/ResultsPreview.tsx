...
const PROOFS = [
  {
    num: '3 нед',
    label: 'вместо 6 месяцев',
    sub: 'Запустили образовательную платформу SigmaUp под ключ',
  },
  {
    num: '0',
    label: 'пропущенных заявок',
    sub: 'После внедрения AI-бота в проекте LifesystemA',
  },
  {
    num: '3×',
    label: 'дешевле агентства',
    sub: 'При том же уровне качества и надёжности',
  },
];
