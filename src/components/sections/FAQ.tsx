...
const FAQS = [
  {
    ...
    a: 'ChatGPT — это процессор. Он не знает ваши процессы, не помнит историю каждого клиента и работает только пока вы пишете промпты. Мы строим среду: документируем процессы, настраиваем агентам память, выстраиваем оркестрацию. После этого AI работает сам — как обученный сотрудник, а не умный поисковик.',
  },
  {
