...
const FAQS = [
  {
    q: 'Мы уже пользуемся ChatGPT / Claude — зачем нам это?',
    a: 'ChatGPT отвечает на вопросы, когда вы его спрашиваете. Мы строим систему, которая работает сама: ведёт клиентов, помнит историю каждого и связана с вашей CRM и Telegram. Вам не нужно писать промпты — агенты делают работу, как обученный сотрудник.',
  },
  {
    q: 'Чем вы отличаетесь от обычного IT-аутсорса или агентства?',
    a: 'Агентства берут деньги за часы и процессы. У нас стоимость фиксируем до старта — после диагностики, и она не растёт по ходу работ. Чёткий срок, и мы сами заинтересованы сделать быстро и работающим — иначе нет смысла. Плюс 30 дней поддержки после запуска включены в цену.',
  },
  {
  ...
  },
  {
    ...
    a: 'Обычно не взлетает по одной причине: шаблонный инструмент внедряли без диагностики — просто потому что «все делают». Мы начинаем с документирования ваших процессов: сначала фиксируем, как реально работает бизнес, потом строим агентов под это. Не наоборот.',
  },
];
      ...
      <div className="faq-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'start' }}>
        ...
        <div className="faq-side" style={{ display: 'flex', flexDirection: 'column', gap: 22, paddingTop: 6, position: 'sticky', top: 72 }}>
          ...
          <p style={{ fontFamily: bebas, fontSize: 32, color: 'var(--ink)', lineHeight: 1.0, letterSpacing: '1px' }}>
            ОТВЕТИМ<br /><span style={{ color: 'var(--accent)' }}>В ТЕЧЕНИЕ 2 ЧАСОВ</span>
          </p>
          ...
          <div style={{ borderTop: '1px solid var(--line2)', paddingTop: 20, display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              'Окупаемость считаем до старта — на диагностике',
