...
const DAYS = [
  ...
  { day: 'День 4', title: 'Карта потерь', desc: 'Показываем, где именно теряются деньги — с цифрами по вашим процессам: что внедрить первым и в каком порядке.' },
];

const AFTER = [
  { option: 'Внедряем с нами', desc: 'Строим агентов, настраиваем память, связываем их с вашей CRM и Telegram. Запуск за 3–6 недель — большинство клиентов выбирают этот путь.' },
