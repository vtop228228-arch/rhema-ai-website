...
const PLANS = [
  {
    ...
    features: [
      ...
      'Roadmap решений с оценкой эффекта',
  ...
  {
    name: 'Глубокий аудит',
    subtitle: 'Для сложных случаев: несколько направлений, филиалы, связки систем',
    price: 'от 30 000 ₽',
    term: '5 - 7 дней',
    features: [
      'Всё из Полной диагностики',
      'Интервью с командой и руководителями',
      'Разбор текущих систем и интеграций',
      'Финансовая модель эффекта внедрения',
...
const AFTER = [
  'Стоимость платного аудита вычитается из стоимости внедрения',
