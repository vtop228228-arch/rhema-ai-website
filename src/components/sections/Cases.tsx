...
const CASES = [
  ...
  {
    title: 'SigmaUp — платформа Академии Черепахина',
    ...
    solution: 'Построили платформу под ключ: первая рабочая версия — через 3 недели, полный запуск с AI-куратором — за 3 месяца. Курсы, личный кабинет студента, тарифная сетка, аналитика, отзывы. Стек: Next.js + Supabase. Полный контроль кода — без зависимости от вендоров.',
    results: [
      'Первая версия через 3 недели, полный запуск за 3 месяца — вместо полугода в агентстве',
