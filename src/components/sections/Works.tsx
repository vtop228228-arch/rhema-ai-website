...
const CASES = [
  {
    ...
    truth: 'Одна точка убыточна и съедает 12% общей прибыли. Об этом узнали только через диагностику.',
    loss: '210к ₽/год',
  },
  {
    tag: 'Онлайн-школа',
    thought: '"Проблема в маркетинге"',
    truth: '30% учеников не получали домашние задания из-за сбоя в рассылке. Возвраты и репутация.',
    loss: '380к ₽/год',
  },
  {
    tag: 'Услуги (B2B)',
    thought: '"Нам нужно больше клиентов"',
    truth: 'Из 40 заявок в месяц менеджер обрабатывал только 22. Остальные терялись в мессенджерах.',
    loss: '260к ₽/год',
  },
];
