...
const SERVICES = [
  ...
  },
  {
    ...
    body: 'Заявки, квалификация клиентов, напоминания, отчёты — рутину забирает AI-агент. Интеграция с Telegram, CRM или сайтом. Работает 24/7, не болеет и не увольняется.',
