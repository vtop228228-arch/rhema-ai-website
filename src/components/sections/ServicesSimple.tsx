...
const SERVICES = [
  {
    ...
    body: 'Ответьте на 2–3 вопроса — AI покажет, где конкретно уходят деньги, что внедрить первым и точки роста.',
  ...
  },
  {
    ...
    body: 'Заявки, квалификация клиентов, напоминания, отчёты — рутину забирает AI-агент.',
  ...
  },
  {
    ...
    body: 'CRM, личный кабинет, дашборды и база знаний компании — под ключ за 3–6 недель. Включает среду для запуска агентов.',
