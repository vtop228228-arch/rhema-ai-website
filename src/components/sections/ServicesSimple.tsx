...
const SERVICES = [
  ...
  {
    num: '02',
    title: 'AI-агенты вместо рутины',
    body: 'Заявки, квалификация клиентов, напоминания, отчёты — рутину забирает AI-агент. Каждый агент знает ваши процессы и помнит историю каждого клиента — не шаблон, а система под вас. Работает 24/7.',
  ...
  },
  {
    ...
    body: 'CRM, личный кабинет, дашборды и база знаний компании — под ключ за 3–6 недель. Включает среду для запуска агентов. Фиксированная стоимость, без «а давайте ещё добавим» за доп. деньги.',
