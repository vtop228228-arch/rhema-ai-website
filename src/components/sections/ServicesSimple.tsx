...
const SERVICES = [
  {
    num: '01',
    title: 'Где ваш бизнес теряет деньги?',
    body: 'За 3 дня покажем конкретные дыры с цифрами в рублях. Не гипотезы — факты. Большинство находят от 200 000 ₽ потерь в год.',
