...
export const SITE_DESCRIPTION =
  'Помогаем с заявками, отчётами и контентом: AI-помощники, автоматизация, сайты и приложения для бизнеса. Начните с бесплатного разбора вашей задачи на сайте.';
