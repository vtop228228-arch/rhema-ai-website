...
> Этот файл читается перед разработкой любого компонента.
> **Источник истины — `src/app/globals.css`.** При расхождении правит код, не этот файл.
> Стиль: **«Ethereal Glass»** — премиальный SaaS/AI/Tech. OLED-чёрный + оранжевый акцент,
> мягкое свечение, стекло, скруглённые углы. (Прошлый минималистичный cyan-вариант — отменён.)
